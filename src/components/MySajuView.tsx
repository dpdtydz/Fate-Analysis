          ...
          <div className="space-y-4 animate-fade-in text-left">
            ...
            <div id="analysis-tabs-anchor" className="bg-surface border border-line rounded-2xl p-4 sm:p-6 space-y-5 shadow-xs">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-line pb-3">
                <div>
                  <h3 className="font-serif text-lg sm:text-xl font-semibold text-ink">내 사주 정밀 분석 리포트</h3>
                  <p className="text-xs text-ink-soft mt-0.5">
              ...
              <div className="flex bg-sunken p-1 rounded-xl gap-1 overflow-x-auto no-scrollbar text-sm select-none">
                {([
                  ...
                  >
                    <span>{tab.label}</span>
                    {tab.premium && !isCouponUnlocked && tab.key !== "mix" && (
              ...
              {/* 3. 심층 리포트: 통합 조화 총평 (1/6 무료 스토리텔링 + 5/6 처방전 블러 점진 해금) */}
              {analysisTab === "mix" && (
                <div className="space-y-4 animate-fade-in">
                  ...
                  <SajuVisual
                    ...
                    onUnlockWithTicket={handleUnlockWithCoupon}
              ...
              {/* 4, 5. 사주 만세력 / 자미두수 명반 탭 */}
              {(analysisTab === "saju" || analysisTab === "ziwei") && (
                <div className="space-y-4 animate-fade-in">
                  {couponMsg && (
                  ...
                  {!isCouponUnlocked ? (
                    ...
                    <div className="bg-sunken rounded-xl p-6 text-center space-y-4">
                      ...
                      <div className="bg-surface p-4 rounded-xl text-left space-y-2 opacity-60 pointer-events-none select-none">
                        <div className="flex justify-between text-xs font-medium text-ink-faint">
                          <span>{analysisTab === "saju" ? "사주 원국표" : "12궁 배치도"}</span>
                          <span>{analysisTab === "saju" ? "10년 대운" : "삼방사정"}</span>
                        </div>
                    ...
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <SajuVisual
                        saju={profile.saju}
                        isPremium={isCouponUnlocked}
                        selectedTab={analysisTab as "saju" | "ziwei"}
                        hideTabNav={true}
                        userName={profile.nickname}
                        birthDate={profile.birth_date}
                        mbti={profile.mbti}
