...
const ELEMENT_SPECS: Record<string, ElementSpec> = {
  "목": {
    ...
    stats: [
      ...
      { label: "성장성", val: 71, color: "#C0392B" },
      { label: "신의", val: 63, color: "#E0A82E" },
  ...
  "화": {
    ...
    stats: [
      ...
      { label: "추진력", val: 66, color: "#35B37E" },
      { label: "직관", val: 72, color: "#C0392B" },
  ...
  "금": {
    ...
    stats: [
      { label: "결단력", val: 75, color: "#7C86A0" },
      { label: "추진력", val: 55, color: "#F0632E" },
      { label: "신의", val: 63, color: "#E0A82E" },
  ...
  "수": {
    ...
    stats: [
      { label: "혜안", val: 76, color: "#3B5BFF" },
      { label: "유연성", val: 72, color: "#35B37E" },
      { label: "결단력", val: 52, color: "#7C86A0" },
