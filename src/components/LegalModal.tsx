  ...
  return (
    ...
    >
      <div
        ...
        className="bg-surface rounded-xl w-full max-w-lg shadow-lg overflow-hidden flex flex-col max-h-[85vh] text-left relative"
      >
        {/* Header */}
        ...
        {/* Tab Switcher */}
        <div className="flex border-b border-line px-4 pt-2 gap-2 overflow-x-auto scrollbar-none">
          <button
            type="button"
            onClick={() => setActiveTab("terms")}
            className={`pb-2.5 px-3 text-xs transition-colors border-b-2 cursor-pointer whitespace-nowrap ${
              activeTab === "terms"
                ? "border-seal text-ink font-semibold"
                : "border-transparent text-ink-faint hover:text-ink font-medium"
            }`}
          >
            이용약관
          </button>
        ...
        <div className="p-5 overflow-y-auto space-y-4 text-xs text-ink-soft leading-relaxed select-text">
          {activeTab === "terms" ? (
            ...
            <div className="space-y-3.5">
              <div className="bg-sunken p-3 rounded-xl text-xs text-ink-soft">
                <span className="font-semibold text-ink">광고 및 쿠키(Cookie) 운영 정책 고지</span><br />
                인연사주는 사용자 편의 향상과 원활한 서비스 광고 송출을 위해 쿠키 기술 및 구글 애드센스(Google AdSense) 플랫폼을 운용합니다.
              </div>

              <p className="font-semibold text-ink">1. 쿠키(Cookie)란 무엇인가요?</p>
              <p>쿠키는 웹사이트를 방문할 때 사용자의 브라우저에 저장되는 작은 텍스트 파일입니다. 쿠키를 통해 사이트는 사용자의 설정을 기억하고 맞춤형 광고를 제공할 수 있습니다.</p>

              <p className="font-semibold text-ink">2. 구글 애드센스(Google AdSense) 및 맞춤형 광고</p>
              ...
              <p className="font-semibold text-ink">3. 쿠키 저장 및 광고 개인 최적화 비활성화 방법</p>
              <p>이용자는 쿠키의 설치 및 사용에 대한 선택권을 가지고 있으며, 원치 않을 경우 언제든지 이를 차단할 수 있습니다.</p>
              <ul className="list-disc pl-4 space-y-1 text-xs text-ink-soft">
                <li><strong>구글 맞춤형 광고 해제</strong>: 구글 광고 설정(<a href="https://adssettings.google.com" target="_blank" rel="noreferrer" className="text-ink-soft underline hover:text-ink">adssettings.google.com</a>)에서 맞춤형 광고 수신을 해제할 수 있습니다.</li>
                <li><strong>웹브라우저 옵션 설정</strong>: 브라우저 상단의 설정 &gt; 개인정보 보호 및 보안 &gt; 쿠키 및 기타 사이트 데이터 메뉴에서 쿠키 수집을 전면 차단하거나 허용할 수 있습니다.</li>
              </ul>

              <p className="font-semibold text-ink">4. 동의 및 거부에 따른 영향</p>
        ...
        <div className="p-4 border-t border-line flex justify-end">
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2.5 bg-sunken hover:bg-line text-ink text-xs font-semibold rounded-xl transition-colors cursor-pointer"
          >
            닫기
          </button>
        </div>
